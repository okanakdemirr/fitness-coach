...
- **Workout Logging** - Create workouts, add exercises from a library of 56+ built-in exercises or add custom ones, track sets/reps/weight with auto rest timer
...
- **Stats & Analytics** - Day streaks, weekly volume, bar charts, personal records, and top muscle groups
